...
We will learn how to connect Ledger to Metamask and use it on Medifakt network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Medifakt network” and perform the transactions on Medifakt network through your Ledger device.

Note: To learn how to add Medifakt network RPC follow [this link.](https://docs.medifakt.network/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
